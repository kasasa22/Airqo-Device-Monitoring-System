  ...
  create view "airflow"."public"."fact_device_status__dbt_tmp"
...
with device_state as (
    select * from "airflow"."public_staging"."stg_current_state"
),

readings as (
    select * from "airflow"."public_staging"."stg_device_readings"
),

devices as (
    select * from "airflow"."public_staging"."stg_devices"
),
